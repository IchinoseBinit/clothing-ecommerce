...
class StructuredFormatting {
  ...
  late final List<SecondaryTextMatchedSubstrings>
  ...
  StructuredFormatting.fromJson(Map<String, dynamic> json) {
    ...
    secondaryTextMatchedSubstrings =
        List.from(json['secondary_text_matched_substrings'])
            .map((e) => SecondaryTextMatchedSubstrings.fromJson(e))
            .toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['secondary_text_matched_substrings'] =
